  ...
  return (
    <div className="flex flex-col h-full gap-4">
      ...
      <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-3 flex items-start gap-3">
        ...
        <div>
            <p className="text-sm text-blue-200 font-medium">Demo Studio generates a structured demo blueprint and voiceover script.</p>
            <p className="text-xs text-blue-300/80">It does NOT record or export an actual video file in this version.</p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full min-h-0">
        {/* Plan Section */}
        <div className="bg-surface border border-gray-700 rounded-xl p-6 shadow-lg flex flex-col min-h-0">
            <div className="mb-4">
                <h3 className="text-xl font-bold text-white flex items-center gap-2">
                    <span className="text-blue-400">●</span> Automated Demo Blueprint (Roadmap)
                </h3>
        ...
        <div className="bg-surface border border-gray-700 rounded-xl p-6 shadow-lg flex flex-col min-h-0">
            <div className="flex justify-between items-center mb-4">
                <div className="space-y-1">
                    <h3 className="text-xl font-bold text-white flex items-center gap-2">
                        <span className="text-purple-400">●</span> AI-Generated Demo Voiceover Script
                    </h3>
                    <p className="text-xs text-gray-400">Designed for screen recording tools.</p>
                </div>
                <button 
                    onClick={handleCopy}
